// src/components/Admins/Product/createProduct.js
// Component to create a new product and add it to the Product DB
...
const CreateProduct = () => {
    ...
    function handleAddProduct(event) {
        ...
        tryAddNewProduct(name, author, description, genre, subGenre, published, navigate);
    }
