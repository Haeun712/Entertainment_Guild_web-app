...
// Component to display detailed information about a customer account (patron) - view only
// order history only available for "Jane Citizen" user due to ProductsInOrders POST error
...
const ViewPatron = () => {
    ...
    return (
        <div style={{ padding: '40px' }}>
            <Button disableRipple onClick={() => navigate("/admin/patrons")} startIcon={<ArrowBackIcon />}
                sx={{
                    color: "Black",
